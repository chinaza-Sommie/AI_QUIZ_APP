  ...
  return (
    <div className='h-screen flex justify-center items-center'>
      <div className="bg-[#151923] border border-[#7589a3] w-[30%] text-center py-9 rounded rounded-md shadow-md shadow-[#7589a3]">
        ...
        <p className="text-[#7589a3] text-xl mb-8"> Test Your Web Dev Knowledge </p>
        <button className="bg-[#7056f6] text-xl text-white py-3 px-6 rounded rounded-md "> Get Started </button>
      </div>
    </div>
  );
}
